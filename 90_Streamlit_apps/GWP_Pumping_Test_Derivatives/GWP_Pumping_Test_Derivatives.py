...
pages = [
    ...
    {
        "id": "inner_boundary_effects",
        "label": lambda: ui_text(
            "🟤 Inner Boundaries",
            de="🟤 Innere Randbedingungen",
            it="🟤 Limiti interni",
            es="🟤 Límites internos",
            pt="🟤 Limites internos",
            fr="🟤 Limites internes",
        ...
        "path": "90_Streamlit_apps/GWP_Pumping_Test_Derivatives/content/05_Inner_Boundary_Deriv.py",
    },
    {
        "id": "boundary_effects",
        "label": lambda: ui_text(
            "🟠 Outer Boundaries",
            de="🟠 Äußere Randbedingungen",
            it="🟠 Limiti esterni",
            es="🟠 Límites externos",
            pt="🟠 Limites externos",
            fr="🟠 Limites externes",
