...
presentation_folder = "90_Streamlit_apps/EGU25/slides/EGU25_Presentation"

# Presettings - Here you can adjust the application to your specific application

header_text = 'The iNUX project'
subheader_text = 'Interactive understanding of groundwater hydrology and hydrogeology'
