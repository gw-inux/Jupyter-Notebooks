...
st.title('Transient Flow toward a well in a confined aquifer is described here using the Theis Solution')
...
with st.expander(":blue[**To proceed with Exercise  1**] click here"):
    st.markdown("""
            **STEP 1:**
...
with st.expander(":blue[**To proceed with Exercise  2**] click here"):
    st.markdown("""
            **STEP 2:**
...
with st.expander(":blue[**To proceed with Exercise  3**] click here"):
    st.markdown("""
            **STEP 3:**
...
st.markdown('''
            ...
            The next part of this application demonstrates how to estimate aquifer parameter values using drawdown data measured near a pumping well. You can move to the next section using either the side menu or the navigation buttons at the bootom of this page.
            '''
)
"---"
