...
with left_co:
    st.image('GWP_Well_capture/assets/images/thomasreimann.png')
with cent_co:
    st.markdown(
        """
...
with left_co2:
    st.image('GWP_Well_capture/assets/images/iNUX_wLogo.png')
with cent_co2:
    st.image('GWP_Well_capture/assets/images/1200px-Erasmus+_Logo.svg.png')