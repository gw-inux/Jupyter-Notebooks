...
st.markdown(
    ...
    :blue[The 1D Conservative Transport Application calculates the breakthrough curve for two types of input sources with ONLY longitudinal dispersion in one-dimensional steady flow through a homogeneous porous medium.] This is representative of solute moving through a laboratory column full of homogeneous sand.
"""
)
...
left_co, cent_co, last_co = st.columns((20,60,20))
with cent_co:
    st.image('90_Streamlit_apps/GWP_1D_Conservative_Transport/assets/images/breakthrough_curve.jpg', caption="Example breakthrough curve at a given distance from the source")
