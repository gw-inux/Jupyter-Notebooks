...
st.set_page_config(
    page_title="Well capture zone2",
    page_icon="💦",
)

st.write("# WellCapture2 App! 💦")
...
with cent_co:
    st.image('90_Streamlit_apps/GWP_Well_capture2/assets/images/wellcapturediagram-sm42.png', caption="Sketch of the well capture zone; modified from Grubb(1993)")
