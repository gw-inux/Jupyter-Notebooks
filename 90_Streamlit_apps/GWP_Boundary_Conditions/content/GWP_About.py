...
st.markdown(
    ...
    The Boundary Condition Module was developed by Thomas Reimann, Eileen Poeter, Eve L. Kuniansky, and the iNUX Team as a Streamlit application and adapted to the Groundwater Project interactive education format. It was released in November of 2025. All Groundwater Project books are available for free download.
    """
)
