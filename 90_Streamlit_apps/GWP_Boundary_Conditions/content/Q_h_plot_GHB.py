...
st.markdown("""
    ...
    Below, under **INPUT CONTROLS**, in the "Modify Plot Controls" drop-down menu, you can toggle to: 1) turn the plot 90 degrees – this different viewing orientation might help you interpret the results, 2) choose between slider or typed input to adjust the parameter values, and 3) increase the range of the $Q_B$ axis, then the plot is redrawn as soon as new values are entered. Under :blue[**"Modify Head Elevations"**], you can adjust the value of groundwater head and GHB head. Finally, under :orange[**"Modify the Conductance"**] you can toggle between entering a value of conductance directly or computing it from geometric and hydraulic properties.
...
def Q_h_plot():
   ...
   # === SHARED FORMATTING === #        
    ...
    DOC_FILE1 = "Q_h_plot_GHB_instructions.md"
    ...
    # Expander with "open in new tab"
    DOC_FILE2 = "Q_h_plot_GHB_exercise.md"
