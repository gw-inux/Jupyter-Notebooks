...
DEFAULT_START_PAGE = "90_Streamlit_apps/Courses/content/GWModell26/GWModell26_Start.py"

# --- MUST be first: layout setup wide / centered ---
if "layout_choice" not in st.session_state:
    st.session_state.layout_choice = "centered"

st.set_page_config(page_title="GWM26 App", page_icon="💦", layout=st.session_state.layout_choice)
st.sidebar.markdown("## 💧 :blue[GWM26 Navigation]")
