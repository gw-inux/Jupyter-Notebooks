...
st.markdown(
    """
    The Freshwater-Saltwater Interface Module includes interactive tools to facilitate conceptual understanding of how 
    the freshwater - saltwater interface. 
    The application uses ** plots **, ....
    """
)
...
with left_co2:
    st.image(st.session_state.module_path + 'images/logo_iNUX.jpg')
with cent_co2:
    st.markdown(
        """
        :blue[**Markus Giese**] is a researcher and lecturer at ...
        """
    )
...
with cent_co4:
    st.markdown(
        """
        :blue[**Nils Wallenberg**] is a researcher and lecturer at ...
        """
    )
#left_co3, cent_co3 = st.columns((20,60))
#with left_co3:
...
st.markdown("""
We sincerely thank all reviewers for the constructive feedback, which greatly helped improve the clarity and educational value of this module.""")
st.markdown("---")
