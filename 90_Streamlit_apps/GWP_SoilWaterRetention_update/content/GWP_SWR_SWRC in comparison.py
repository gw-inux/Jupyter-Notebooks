...
st.subheader(
    ...
    ui_text(
        ...
        de="Vergleich von Datensätzen",
        it="Confronto tra set di dati",
        es="Comparación de conjuntos de datos",
...
st.subheader(
    ui_text(
        "Available Data Sets",
        de="Verfügbare Datensätze",
        it="Set di dati disponibili",
        es="Conjuntos de datos disponibles",
...
st.markdown(load_md(MD_DIR, "swr_comp_02.md", st.session_state.language))

with st.expander('**Click here if you want to see the available data sets**'):
    st.markdown(load_md(MD_DIR, "swr_comp_03.md", st.session_state.language))
...
st.subheader(
    ui_text(
        "📊 Interactive Plot Comparing Soil Water Retention Curves for Different Soil Types",
        de="📊 Interaktives Diagramm zum Vergleich von Bodenwasserretentionskurven verschiedener Bodenarten",
        it="📊 Grafico interattivo per confrontare le curve di ritenzione idrica di diversi tipi di suolo",
        es="📊 Gráfico interactivo para comparar las curvas de retención de agua de diferentes tipos de suelo",
...
st.markdown(load_md(MD_DIR, "swr_comp_04.md", st.session_state.language))

with st.expander("**Click here for instructions about how to work with this interactive tool**"):
    st.markdown(load_md(MD_DIR, "swr_comp_05.md", st.session_state.language))
