...
with cent_co3:
    st.markdown(
        """
        :blue[**Daniel Fernàndez-Garcia**] is a Full Professor at the Department of Civil and Environmental Engineering at the Universitat Politècnica de Catalunya (UPC), where he plays a leading role within the Barcelona Groundwater Hydrogeology Group. With over 20 years of experience in hydrogeology, his research focuses on modeling flow and solute transport in porous media, risk analysis, and groundwater management.
...
with left_co4:
    st.image('90_Streamlit_apps/GWP_SoilWaterRetention/assets/images/eileen.poeter.jpg')
with cent_co4:
    st.markdown(
        """
