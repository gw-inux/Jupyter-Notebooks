...
This table shows the available data sets. You can choose the data sets by using the dropdown menu in the following interactive plot.
                
The data are from Carsel and Parrish (1988):
