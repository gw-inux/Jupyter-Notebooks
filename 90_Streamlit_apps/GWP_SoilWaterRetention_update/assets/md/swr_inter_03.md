...
Use this interactive app to explore how soil properties shape the water retention curve and plant-available water by following the steps below:
...
- **Residual water content** $\theta_r$: affects the lower bound of the curve.
...
- The **pressure head** at the curve inflection points.
        
4. **Using the Plot controls, activate the field capacity (FC)** and **permanent wilting point (PWP)** markers using the toggles:
...
7. **Try to maximize eFC** (effective plant-available water) by adjusting the combination of parameter values — can you find an “optimal” soil?
        
8. **Reflect on real-world relevance**:
- How would knowing soil parameters and their influence on the soil-water retention curve affect **irrigation planning** or **crop growth**?