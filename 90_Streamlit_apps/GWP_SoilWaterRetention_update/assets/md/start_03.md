...
This module is designed as a step-by-step guide for students, professionals, and anyone interested in understanding the fundamental concepts of unsaturated zone hydraulics. It is particularly suitable for learners who are new to the topic, while also serving as a concise refresher for practitioners who wish to revisit the relationships between soil water content, suction head, saturation, and hydraulic conductivity before applying them in groundwater, agricultural, or environmental studies.
...
The module begins with an introduction to the physical concepts governing water flow in the unsaturated zone and explains the relationships between suction head, water content, saturation, and hydraulic conductivity. The theoretical background is complemented by interactive applications that allow learners to investigate the influence of the van Genuchten and Mualem parameters for different soil types.
