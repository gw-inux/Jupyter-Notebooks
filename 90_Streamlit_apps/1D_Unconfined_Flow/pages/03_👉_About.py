...
st.markdown(
    """
    ### Description
    The interactive tool calculates the hydraulic heads for an unconfined, homogeneous, isotropic aquifer with recharge and two defined head boundaries.
    
    ### Development
    WellCapture was developed by Thomas Reimann as a Jupyter notebook.
