...
gfw_1D_unconf_rech_OM = st.Page("pages/GWF/1D_GWF_Unconfined Recharge.py", title="📈_▶️ 1D GWF unconfined with recharge")
well_capture_OM = st.Page("pages/GWF/WellCapture.py", title="📈_▶️ Well Capture")
