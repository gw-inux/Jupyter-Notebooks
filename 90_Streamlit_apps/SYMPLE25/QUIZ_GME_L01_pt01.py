...
path_quest_final = "90_Streamlit_apps/SYMPLE25/questions/MCQ_L01_pt1.json"
...
st.title("QUIZ")
st.subheader("The Groundwater Modeling :rainbow[Enterprise] *by Sorab Panday*", divider = "green")

st.markdown("""
#### Preface
This quiz covers :red[**Lecture 01 - part 01**] of the 2026 Groundwater Modeling Enterprise Course.
""")
