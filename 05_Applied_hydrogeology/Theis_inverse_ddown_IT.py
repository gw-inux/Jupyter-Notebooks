...
st.title('Predizione di abbassamento con Theis - Adattamento del parametro della formazione ai dati misurati')
st.markdown("""
...
m_time_s = [i * 60 for i in m_time]  # tempo in secondi
