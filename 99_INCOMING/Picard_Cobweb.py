...
st.title("Picard Iteration – Cobweb Diagram")
st.markdown(
    """
    **Based on:** Mehl, S.W. (2006). *Use of Picard and Newton Iteration for Solving
    ...
    `h = f_p(h)`. The fixed point is where the curve intersects the diagonal `h = h`.
    """
)
...
# ─────────────────────────────────────────────
FUNCTION_OPTIONS = {
    "Mehl (2006) Fig.1 – Piecewise jump, converging staircase":     "fig1",
    "Mehl (2006) Fig.2 – Step function, diverging staircase":       "fig2",
    "Mehl (2006) Fig.3 – Hyperbola K/h, oscillating spiral":        "fig3",
    "Mehl (2006) Fig.4 – Piecewise notch, slow staircase":          "fig4",
    "Mehl (2006) – Default converging  (C/h^0.7)":                  "mehl_default",
    "Mehl (2006) – Slow converging     (C/h^0.3)":                  "mehl_slow",
    "Oscillating convergence           (slope = −0.85)":            "oscillating",
    "Oscillating divergence            (slope = −1.40)":            "oscillating_div",
    "Random: Linear  (custom slope & intercept)":                   "random_linear",
    "Random: Nonlinear  (custom √h + linear)":                      "random_nonlinear",
}
...
ax.set_ylabel(r"$f_p(h)$", fontsize=13)
ax.set_title("Picard Iteration – Cobweb Convergence Pattern\n(Mehl, 2006)", fontsize=12)
